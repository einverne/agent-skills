...
- Plain text files with `.bean` or `.beancount` extension (this project uses `.bean`)
...
Example:
```beancount
2026-01-01 custom "budget" Expenses:Food 500.00 CNY
2026-01-01 custom "fava-option" "fiscal-year-end" "06-30"
```

#### Fava-specific custom directives

```beancount
; Fava behavior options
2016-04-14 custom "fava-option" "language" "zh_CN"       ; UI language
2016-04-14 custom "fava-option" "auto-reload" "true"     ; auto-reload on file change
2016-04-14 custom "fava-option" "indent" "2"             ; indentation size
2016-04-14 custom "fava-option" "fiscal-year-end" "12-31"

; Sidebar quick-access links (use far-future date so they're always present)
...
option "operating_currency" "CNY"       ; can be repeated for multi-currency
option "operating_currency" "JPY"
option "operating_currency" "USD"
option "documents" "documents/"
option "inferred_tolerance_default" "*:0.01"   ; ignore sub-cent rounding for all currencies
